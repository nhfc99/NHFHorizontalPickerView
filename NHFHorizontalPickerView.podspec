Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.source_files = 'NHFHorizontalPickerView/HorizontalPickerView/*.{h,m}','NHFHorizontalPickerView/NHFHorizontalPickerView/HorizontalPickerView/HorizontalPickerViewUICollectionViewCell/*.{h,m}'
